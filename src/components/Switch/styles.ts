...
export const SwitchInput = styled.input.attrs<{
	...
	${props => {
		switch (props.size) {
          ...
          &:active div {
            width: ${
							props.disabled ? variables.size.size.sm : variables.size.size.size
						}px;
          }

          svg {
            width: calc(${variables.size.size.sm}px - ${
					variables.size.size.xxs
				}px);
            height: calc(${variables.size.size.sm}px - ${
					variables.size.size.xxs
				}px);
          }
        }
      `
          ...
          &:active div {
            width: ${
							props.disabled ? variables.size.size.ms : variables.size.size.lg
						}px;
          }

          svg {
            width: calc(${variables.size.size.ms}px - ${
					variables.size.size.xxs
				}px);
            height: calc(${variables.size.size.ms}px - ${
					variables.size.size.xxs
				}px);
          }
        }
      ...
      svg {
        ...
        fill: ${
					props.checked
						...
						: variables.colors.neutral.backgroundBase.colorBgMask.light
				};
      }
    }
  `}
